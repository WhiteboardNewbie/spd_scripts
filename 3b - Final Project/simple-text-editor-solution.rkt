...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname simple-text-editor-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
