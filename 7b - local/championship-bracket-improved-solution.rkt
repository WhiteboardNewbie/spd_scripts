...
;; This program defines a function called ouster
;; that consumes a tournament bracket and a team name,
;; and produces the name of the team that eliminated the given team, or false if none.
;; The improved version uses a local expression to encapsulate helper definitions,
;; improving readability and avoiding repetition.
;; Using local helps structure the function clearly by grouping related helpers and values together.
...
;; local added to avoid recomputation 