## Rain maker
For sure one of the most intriguing programs in the course. It was a tedious exercise in designing helper functions but the culmination was a very organised program and a beautiful animation for rainfall, very satisfying!
```
(require 2htdp/image)
...
(define (render-next-drop d im)
  (place-image DROP
               ...
               im))
```
![The Rain Maker](/assets//gifs/rain-maker.gif)